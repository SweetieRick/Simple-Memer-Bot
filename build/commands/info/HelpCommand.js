    ...
    run(client, message, args) {
        return __awaiter(this, void 0, void 0, function* () {
            let embed = new discord_js_1.MessageEmbed()
                ...
                .addField("⚙️ Utility Commands", `${client.prefix}nightwatch, ${client.prefix}onlinemode`, true)
                .addField("🔐 Developer Reserved", `s!test, s!showtable`, true)
                .setColor(0xa3ae7e)
                .setFooter("Bot made by SweetieRick, check me out [here](https://discord.gg/8BrJz3E)");
