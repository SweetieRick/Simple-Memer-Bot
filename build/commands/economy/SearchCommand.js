...
class ExploreCommand extends BaseCommand_1.default {
    constructor() {
    ...
    run(client, message, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (bot_1.cooldownUserList.has(message.author.id)) {
                ...
                bot_1.cooldownUserList.add(message.author.id);
                setTimeout(() => {
                    // Removes the user from the set after 15 seconds
                    bot_1.cooldownUserList.delete(message.author.id);
                }, 10000);
            }
        });
    }
}
exports.default = ExploreCommand;
